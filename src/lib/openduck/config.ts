...
export const INJECT_CURRENT_TIME_STORAGE_KEY = "openduck.inject-current-time.v1";
...
export const DEFAULT_END_OF_UTTERANCE_SILENCE_MS = 3500;
...
export const DEFAULT_SMART_TURN_THRESHOLD = 0.9;
...
export const DEFAULT_COMMIT_AUDIO_DRAIN_MS = 1300;
export const MIN_COMMIT_AUDIO_DRAIN_MS = 100;
export const MAX_COMMIT_AUDIO_DRAIN_MS = 2500;
...
export const DEFAULT_INJECT_CURRENT_TIME = true;
