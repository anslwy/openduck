...
pub(crate) const CALL_START_GRACE_PERIOD_MS: u64 = 3500;
...
pub(crate) const DEFAULT_AUTO_CONTINUE_SILENCE_MS: Option<u32> = None;
pub(crate) const MIN_AUTO_CONTINUE_SILENCE_MS: u32 = 3000;
pub(crate) const MAX_AUTO_CONTINUE_SILENCE_MS: u32 = 7000;
...
pub(crate) const COMMIT_AUDIO_DRAIN_MS: u64 = 200;
pub(crate) const MIN_COMMIT_AUDIO_DRAIN_MS: u64 = 100;
pub(crate) const MAX_COMMIT_AUDIO_DRAIN_MS: u64 = 1200;
...
pub(crate) const SMART_TURN_RUNTIME_MARKER_FILE: &str = ".smart-turn-v1";
pub(crate) const SMART_TURN_REQUIRED_PYTHON_MODULES: &[&str] = &["onnxruntime", "transformers"];
...
pub(crate) const CSM_MALE_REFERENCE_TEXT_FILE: &str = "sample-male-transcript.txt";
pub(crate) const CSM_FEMALE_REFERENCE_AUDIO_FILE: &str = "sample-female.mp3";
pub(crate) const CSM_FEMALE_REFERENCE_TEXT_FILE: &str = "sample-female-transcript.txt";
...
pub(crate) const DEFAULT_LLM_CONTEXT_TURN_LIMIT: Option<usize> = Some(7);
pub(crate) const MIN_LLM_CONTEXT_TURN_LIMIT: usize = 2;
pub(crate) const MAX_LLM_CONTEXT_TURN_LIMIT: usize = 50;
pub(crate) const DEFAULT_LLM_IMAGE_HISTORY_LIMIT: Option<usize> = None;
pub(crate) const MIN_LLM_IMAGE_HISTORY_LIMIT: usize = 1;
pub(crate) const MAX_LLM_IMAGE_HISTORY_LIMIT: usize = 9;
pub(crate) const DEFAULT_MAX_SPOKEN_SENTENCES_PER_SEGMENT: usize = 2;
pub(crate) const MIN_SPOKEN_SENTENCES_PER_SEGMENT: usize = 1;
pub(crate) const MAX_MAX_SPOKEN_SENTENCES_PER_SEGMENT: usize = 8;
pub(crate) const SMART_TURN_THRESHOLD: f32 = 0.95;
pub(crate) const MIN_SMART_TURN_THRESHOLD: f32 = 0.0;
pub(crate) const MAX_SMART_TURN_THRESHOLD: f32 = 1.0;
pub(crate) const MAX_SPOKEN_WORDS_PER_SEGMENT: usize = 160;
pub(crate) const MAX_SPOKEN_WORDS_PER_SEGMENT_HARD_LIMIT: usize = 240;
pub(crate) const MAX_SPOKEN_CJK_CHARS_PER_SEGMENT: usize = 420;
pub(crate) const MAX_SPOKEN_CJK_CHARS_PER_SEGMENT_HARD_LIMIT: usize = 640;
