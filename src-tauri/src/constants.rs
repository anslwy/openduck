...
pub(crate) const ADAPTIVE_ENDPOINTING_SHORT_UTTERANCE_MS: u32 = 1200;
pub(crate) const ADAPTIVE_ENDPOINTING_LONG_UTTERANCE_MS: u32 = 4000;
pub(crate) const ADAPTIVE_ENDPOINTING_MIN_SILENCE_RATIO_PERCENT: u32 = 50;
...
pub(crate) const STREAMING_INCOMPLETE_SEGMENT_FLUSH_WORDS: usize = 12;
pub(crate) const STREAMING_INCOMPLETE_SEGMENT_FLUSH_MS: u64 = 700;
